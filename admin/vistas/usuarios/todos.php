...
foreach ($campos as $campo) {
    ...
    $idcajaporuser  = Ingresos::obtenerIdcajaporUser($id_usuario);

    if ($idcajaporuser!="") {
       $inicial        = Cajas::obtenerInicialpor($idcajaporuser);
    $entradascaja   = Cajas::obtenerEntradaspor($idcajaporuser);
    $entradascuenta = Cajas::obtenerEntradasporcuenta($idcajaporuser);
    $salidas        = Cajas::obtenerSalidaspor($idcajaporuser);
    ...
    ?>
            <tr>
              ...
              <td><?php echo utf8_encode($nombre_usuario); ?></td>
               <td> <?php Echo utf8_encode("$ ".number_format($saldofinal));  ?></td>
              <td><?php echo utf8_encode($username); ?></td>
              <td><?php echo utf8_encode($nombrerol); ?></td>
              <td>
              ...
              <a href="#" onclick="eliminar(<?php echo $id_usuario; ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminar">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=usuarios&&action=eliminar&&id="+id;
else
