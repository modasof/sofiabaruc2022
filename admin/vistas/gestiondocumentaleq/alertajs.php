...
$destinatario = "comercial@transbaruc.com,operaciones@transbaruc.com"; 
...
<head>
    ...
    <title>Sofia Transbaruc.com</title> 
            ...
            <table role='presentation' border='0' cellpadding='0' cellspacing='0' width='100%'>
               <tr>
                  <td class='logo' style='text-align: left;''>
                     <h1><a href='https://transbaruc.com/sofia/Login/'><i class='fa fa-bell'> </i> Software Sofia</a></h1>
                   </td>
               </tr>
            </table>
          </td>
                 ...
                 <tr style='border-bottom: 1px solid rgba(0,0,0,.05);'>
                  <td colspan='2' valign='middle' width='100%' style='text-align:left; padding: 0 2.5em;'>
                     <div class='product-entry'>
                        <img src='https://transbaruc.com/sofia/Login/logo-ppal2.png' alt='' style='width: 100px; max-width: 600px; height: auto; margin-bottom: 20px; display: block;'>
                        <div class='text'>
...
<?php 
   ...
   <tr>
                  <td valign='middle' style='text-align:left; padding: 1em 2.5em;'>
                     <p><a href='https://transbaruc.com/sofia/Login/' class='btn btn-primary'>Ir a la plataforma</a></p>
                  </td>
                 </tr>
   </table>
         </tr><!-- end tr -->
...
$headers .= "From: Software Sofia <notificaciones@teksystem.co>\r\n"; 


//direcciones que recibirán copia oculta 
$headers .= "Bcc: fogonzalez.ms@gmail.com\r\n"; 
