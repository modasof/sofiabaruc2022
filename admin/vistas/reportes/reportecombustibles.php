...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reporte Combustible</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
            	...
            	require_once 'formreportecombustible.php';
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Despachos Combustible </h3>
      ...
      if ($RolSesion!=4) {
       ?>
        <form action="?controller=reportes&&action=combustiblesporfecha" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
  ...
  console.log('New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')');
       ...
       <div class="col-sm-12">
        ...
        if ($fechaform!="") {
          ?>
           <h3 class="m-0 text-dark">Reporte Combustible del <?php echo(fechalarga($datofechain)) ?> al <?php echo (fechalarga($datofechafinal)) ?></h3>
          <?php
        }
        else
        {
          ?>
           <h3 class="m-0 text-dark">Reporte Total Combustible 
            <?php 
            if ($RolSesion==4) {
              $reportadopor=Usuarios::obtenerNombreUsuario($IdSesion);
              echo utf8_decode($reportadopor);
            }
       ...
       <tbody>
            ...
            <tr>
              <td>
                <?php 
              // Ocultamos los botones de Editar para el Rol Conductor
                if ($RolSesion!=4) {
                 ?>
              ...
              <a href="?controller=reportes&&action=editarcombustible&&id=<?php echo $id; ?>&&vereditar=1" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Despacho">
                <i class="fa fa-edit bigger-110 "></i>
              </a>
              <a href="#" onclick="eliminar(<?php echo $id; ?>);" class="tooltip-primary text-danger" data-rel="tooltip" data-placement="top" title="" data-original-title="Eliminare Despacho">
...
<form action="?controller=reportes&&action=clienteextra&&tiporeporte=2" method="post" autocomplete="off">
...
<form action="?controller=reportes&&action=productoextra&&tiporeporte=2" method="post" id="FormArpetura" autocomplete="off">
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      <div class="modal-header">
