...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Reporte Kilometraje - Planillas</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
?>
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Reportes Kilometraje - Planillas </h3>
...
?>
       ...
       <tbody>
            <?php
if ($fechaform != "") {
    $res    = Reportes::ReporteHorasporfecha($FechaStart, $FechaEnd);
...
foreach ($campos as $campo) {
    ...
    $idpropietario      = Propietarios::Idpropietarioporveh($equipo_id_equipo);
    $nompropietario     = Propietarios::obtenerNombre($idpropietario);
    $ventatotal         = $cantidad * $valor_m3;
    ?>
            <tr>
              <td>
              <a href="?controller=reportes&&action=editarhoras&&id=<?php echo $id; ?>&&vereditar=1" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Horas">
              ...
              <td><?php echo (round($hora_inactiva,2)) ?></td>
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=reportes&&action=eliminarhoras&&id="+id;
else
