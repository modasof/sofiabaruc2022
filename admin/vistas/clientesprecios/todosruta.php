  ...
  <div class="content">
    ...
    <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"> Crear Nueva Ruta 
    ...
    <form role="form" autocomplete="off" action="?controller=clientesprecios&&action=guardar&id_cliente=<?php echo($ClienteSel); ?>" method="POST" enctype="multipart/form-data" >
                            <?php  
                ...
                <input type="hidden" name="canal_venta" value="fletes">
                <input type="hidden" name="valor_producto" value="0">
                ...
                <input type="hidden" name="creado_por" value="<?php echo($IdSesion);?>">
                    ...
                    <div class="card-body">
                            <div class="row">
                                ...
                                <select  class="form-control mi-selector0" id="origen_id" name="origen_id" required>
                                        <option value="" selected>Seleccionar Destino...</option>
                                        <?php
                                        $rubros = Destinos::obtenerListaDestinos();
                                        foreach ($rubros as $campo){
                                            $id_destino1 = $campo['id_destino'];
                                            $nombre_destino1 = $campo['nombre_destino'];
                                        ?>
                                        <option value="<?php echo $id_destino1; ?>"><?php echo utf8_encode($nombre_destino1); ?></option>
                                        <?php } ?>
                                </select>
                                ...
                                <select  class="form-control mi-selector" id="destino_id" name="destino_id" required>
                                        <option value="" selected>Seleccionar Destino...</option>
                                        <?php
                                        $rubros = Destinos::obtenerListaDestinos();
                                        foreach ($rubros as $campo){
                                            $id_destino = $campo['id_destino'];
                                            $nombre_destino = $campo['nombre_destino'];
                                        ?>
                                    ...
                                    <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" name="valor_m3km" placeholder="Valor del m3/km" class="form-control" id="demo1">
                                                </div>
                                    </div>
                                      <div style="display: none;" class="col-md-3">
                                                <div class="form-group">
                                                    <label>Valor del Producto: <span>*</span></label>
                                                    <input  type="text" name="valor_producto" placeholder="Valor del m3/km" class="form-control" id="demo2">
                                                </div>
                                    </div>
                                     ...
                                     <div style="display: none;" class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input  type="text" name="valor_horamq" placeholder="Valor del m3/km" class="form-control" id="demo3">
                                                </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="any" name="km_ruta" placeholder="Kilometros" class="form-control" required value="">
    ...
    <div class="card card-default">
      ...
      <div class="clearfix">
          ...
          <tbody>
            ...
            $origen_id = $campo['origen_id'];
            $destino_id= $campo['destino_id'];
            $valor_m3km = $campo['valor_m3km'];
            $km_ruta = $campo['km_ruta'];
            $marca_temporal = $campo['marca_temporal'];
            $creado_por = $campo['creado_por'];

            $nomorigen=Destinos::obtenerNombreDestino($origen_id);
            $nomdestino=Destinos::obtenerNombreDestino($destino_id);
            ...
            <tr>
              ...
              <td><?php echo utf8_encode($id) ?></td>
               <td><?php echo utf8_encode($nomorigen) ?></td>
                <td><?php echo utf8_encode($nomdestino) ?></td>
              <td><?php Echo utf8_encode("$".number_format($valor_m3km));  ?></td>
              <td><?php echo utf8_encode($km_ruta) ?></td>
              ...
              <button  type="button" class="btn btn-default btn-flat"> <a href="#" onclick="eliminar(<?php echo $id; ?>,<?php echo($ClienteSel) ?>);" class="tooltip-primary text-danger" title="Eliminar Ruta">
...
<script>
function eliminar(idegreso,$ClienteSel){
   eliminar=confirm("¿Deseas eliminar este registro?");
   if (eliminar)
window.location.href="?controller=clientesprecios&&action=eliminar&&id="+idegreso+"&&id_cliente="+$ClienteSel+"";
else
