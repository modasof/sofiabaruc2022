...
<div class="content-wrapper">
  ...
  <div class="content">
    ...
    <div class="card card-primary">
      <div class="card-body">
          <a href="?controller=clientes&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-plus-square bigger-110 "></i> Crear Cliente</a>
          <br><br>
...
foreach ($campos as $campo) {
    ...
    ?>
            <tr>
               <td><?php echo utf8_decode($id); ?></td>
              <td><?php echo utf8_decode($nit); ?></td>
              <td><?php echo utf8_decode($nombre_cliente); ?></td>
              <td><?php echo utf8_decode($nomoperador); ?></td>
               <td><?php echo utf8_decode($correo_cliente); ?></td>
               <td><?php echo utf8_decode($direccion_cliente); ?></td>
                <td><?php echo utf8_decode($tel1_cliente); ?></td>
                <td><?php echo utf8_decode($tel2_cliente); ?></td>
                <td><?php echo utf8_decode($contacto_cliente); ?></td>
