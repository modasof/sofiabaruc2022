...
<div class="content-wrapper">
  ...
  <div class="content">
    ...
    <div class="card card-primary">
      <div class="card-body">
          <a href="?controller=operadores&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-plus-square bigger-110 "></i> Crear Operador</a>
          <br><br>
    ...
    <!--  <div class="card-header">
      ...
      <div class="clearfix">
       ...
       <tbody>
            ...
            $id = $campo['id_operador'];
            $nombre_operador = $campo['nombre_operador'];
            
            ?>
            <tr>
              <td><?php echo utf8_encode($id); ?></td>
              <td><?php echo utf8_encode($nombre_operador); ?></td>
             
              
             
              <td>
              <a href="?controller=operadores&&action=editar&&id=<?php echo $id; ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Editar Operador">
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=operadores&&action=eliminar&&id="+id;
else
