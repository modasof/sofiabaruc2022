...
<i class="fa fa-edit"></i> CxP Proveedor
</a>
...
?>
      ...
      <div class="table-responsive mailbox-messages">
       ...
       <tbody>
            <?php
            if ($fechaform!="") {
              $res=Compras::porfechacompraproyecto($FechaStart,$FechaEnd);
              $campos = $res->getCampos();
              $comprasfechainsumos=Comprasmesgeneralfechatipo($FechaStart,$FechaEnd,'Insumos');
              $comprasfechaservicios=Comprasmesgeneralfechatipo($FechaStart,$FechaEnd,'Insumos');
