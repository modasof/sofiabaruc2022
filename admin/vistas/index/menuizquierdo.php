    ...
    <section class="sidebar">
     ...
     <?php }?>
         ...
         <li  class="treeview">
          ...
          <ul class="treeview-menu">
      <?php if ($m_tje == "Si") {?>
           <li class=""><a href="?controller=tareaje&&action=todos"><i class="fa fa-list"></i> Total Servicios</a></li>
     <?php }?>
      <?php if ($m_tje_nuevo == "Si") {?>
          <li class=""><a href="?controller=tareaje&&action=nuevo"><i class="fa fa-list"></i>Tareaje</a></li>
     <?php }?>
          ...
          <ul class="treeview-menu">
            <?php if ($m_operadores == "Si") {?>
            <li class=""><a href="?controller=operadores&&action=todos"><i class="fa fa-circle-o"></i>Operadores</a></li>
          <?php }?>
