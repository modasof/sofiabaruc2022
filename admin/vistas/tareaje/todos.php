...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Tareaje</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?controller=index&&action=index">Inicio</a></li>
            <li class="breadcrumb-item active">Tareaje</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
              <form action="?controller=tareaje&&action=todos" method="post" id="FormFechas" autocomplete="off">
         <div class="col-md-8">
...
if ($fechaform != "") {
    ?>
           <h3 class="m-0 text-dark">Reporte Tareaje del <?php echo (fechalarga($datofechain)) ?> al <?php echo (fechalarga($datofechafinal)) ?></h3>
          <?php
} else {
    ?>
           <h3 class="m-0 text-dark">Reporte Total Tareaje</h3>
          <?php
}
...
?>
    ...
    <div class="card card-primary">
      <div class="card-body">
          <a  href="?controller=tareaje&&action=nuevo" class="btn btn-success" style="float: right;"><i class="fa fa-plus-square bigger-110 "></i> Crear Nuevo</a>
          <br><br>
    ...
    <!--  <div class="card-header">
      ...
      <div class="clearfix">
          ...
          <table id="cotizaciones" class="table  table-responsive table-striped table-bordered table-hover" style="width: 100%;font-size: 11px;">
       ...
       <tbody>
            <?php
 if ($fechaform!="") {
              $res=Tareaje::Reporteporfecha($FechaStart,$FechaEnd);
...
foreach ($campos as $campo) {
    ...
    $totalcomentarios = contarcomentariostareaje($id);

$horaInicio = new DateTime($hora_inicio);
$horaTermino = new DateTime($hora_final);
    ...
    ?>
            <tr>
             ...
             <td>
                  ...
                  <br>
                     <a target="_blank" href="?controller=tareaje&&action=trazabilidad&&iditem=<?php echo ($id) ?>" class="tooltip-primary text-success" data-rel="tooltip" data-placement="top" title="" data-original-title="Trazabilidad">
                <i class="fa fa-comments bigger-110 "> Trazabilidad <?php echo ($totalcomentarios); ?></i>
              </a>
              ...
              <td><?php echo utf8_decode($hora_inicio); ?></td>
              <td><?php echo utf8_decode($hora_final); ?></td>
              <td><?php echo utf8_decode($km_inicial); ?></td>
              <td><?php echo utf8_decode($km_final); ?></td>
              <td><?php echo utf8_decode($total_km); ?></td>
...
function eliminar(id){
   ...
   if (eliminar)
     window.location.href="?controller=clientes&&action=eliminar&&id="+id;
else
